...
import org.example.academicservice.repository.MatiereRepository;
...
public class MatiereServiceImpl implements MatiereService {
    ...
    public List<MatiereDTO> getAll() {
        return matiereRepository.findAllWithModule()
                .stream()
                .map(this::toDTO)
    ...
    public List<MatiereDTO> search(String nom) {
        return matiereRepository.searchWithModule(nom)
                .stream()
                .map(this::toDTO)
                .collect(Collectors.toList());
    }
        ...
        if (dto.getModuleId() != null) {
            module = moduleRepository.findById(dto.getModuleId())
                    .orElseThrow(() -> new EntityNotFoundException(
                            "Module non trouvé : " + dto.getModuleId()));
        }
